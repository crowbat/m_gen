...
public class PCM2Wav {
	...
	public void writeHeader(int size, FileOutputStream outFile, PCM2Wav a) {					//Method for creating a header for the wav file and writing it to the output file
	...
	public String toLittleEndian(String num, int numBytes) {							//takes a base 10 number inside a string and converts it to a hex string in little endian form
	...
	public void writeHexToWav(String hex, FileOutputStream outFile) {						//Takes a string of hex values, converts every two hex numbers into a character and writes the character to the output file
		try {
